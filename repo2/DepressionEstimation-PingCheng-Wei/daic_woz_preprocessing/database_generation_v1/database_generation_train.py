...
if __name__ == '__main__':
    ...
    root = '/users/swilli43/scratch/processed_data'
    ...
    gt_path = '/users/swilli43/thesis/DepressionEstimation-PingCheng-Wei/daic_woz_preprocessing/Excel for splitting data/train_split_Depression_AVEC2017.csv'
    ...
    for i in range(len(gt_df)):
        ...
        # /users/swilli43/thesis/DepressionEstimation-PingCheng-Wei/daic_woz_preprocessing/database_generation_v1/database_generation_train.py
        text_path = f"/users/swilli43/scratch/raw_data/{patient_ID}_P/{patient_ID}_TRANSCRIPT.csv"
        keypoints_path = f'/users/swilli43/scratch/raw_data/{patient_ID}_P/{patient_ID}_CLNF_features3D.txt'
        gaze_path = f'/users/swilli43/scratch/raw_data/{patient_ID}_P/{patient_ID}_CLNF_gaze.txt'
        audio_path = f'/users/swilli43/scratch/raw_data/{patient_ID}_P/{patient_ID}_AUDIO.wav'
        audio_trans_path = f'/users/swilli43/scratch/raw_data/{patient_ID}_AUDIO_trans.wav'
